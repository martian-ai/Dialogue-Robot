...
# https://paperswithcode.com/paper/dureaderrobust-a-chinese-dataset-towards/review/
...
class DureaderRobust(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        dl_dir = dl_manager.download_and_extract(url_or_urls=_URL)
...
if __name__ == '__main__':
    datasets_dureader_robust = DureaderRobust()
    downloadr_manager = DownloadManager()
    path_list = datasets_dureader_robust._split_generators(downloadr_manager)
    print(path_list)
    for item in path_list:
        ret = datasets_dureader_robust._generate_examples(item.gen_kwargs['filepath'])
        for _item in ret:
            print(_item)