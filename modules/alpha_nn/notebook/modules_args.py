...
# save
parser.add_argument('--target_dir', default="tmp", type=str, help='target dir for current model')
parser.add_argument('--log_dir', default="log", type=str, help='log dir for current train')
