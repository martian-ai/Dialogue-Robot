...
if __name__ == "__main__":
    main("../../../../../resources/dataset/local/match/sup_lcqmc/train.tsv", "../../../../../resources/dataset/local/match/sup_lcqmc/dev.tsv", "models-roberta-lcqmc")
    # ../../../../../resources/dataset/local/match/sup_lcqmc/test.tsv
