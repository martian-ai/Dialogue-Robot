...
class BertModel(nn.Module):
    def __init__(self):
        ...
        self.bert = BertForSequenceClassification.from_pretrained("roberta_joint_sup_training", num_labels = 2)  # /bert_pretrain/
...
class BertModelTest(nn.Module):
    def __init__(self):
        ...
        config = BertConfig.from_pretrained('roberta_joint_sup_training')
