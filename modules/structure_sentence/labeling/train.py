...
from learner.nn_with_bert.function.modeling import BertConfig
from modules.utils_tokenizer.bert import Tokenizer4Bert 
from modules.utils_dataset.NERDataset import CLFDataset
...
class Instructor:
    def __init__(self, opt):
        ...
        config = BertConfig(vocab_size_or_config_json_file='../../resources/models/embedding/bert-base-chinese/bert_config.json')
    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            val_acc = self._evaluate_crf_acc(val_data_loader)
    ...
    def _evaluate_crf_acc(self, data_loader):
        """
        进行分类能力的评估
        """
    ...
    def run(self):
        ...
        test_acc = self._evaluate_crf_acc(test_data_loader)
