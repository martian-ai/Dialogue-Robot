...
from modules.utils.tokenizer.tokenization import (BasicTokenizer, whitespace_tokenize)
from modules.question_answering.bert_sinlgespan.function.utils_squad_evaluate import (
    find_all_best_thresh_v2, get_raw_scores, make_qid_to_has_ans)
...
class SquadExample(object):
    ...
    def __init__(self, qas_id, question_text, doc_tokens, orig_answer_text=None, start_position=None, end_position=None, recall_score=None, is_impossible=None):
        self.qas_id = qas_id
