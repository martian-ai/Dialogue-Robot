...
def main(args):
    ...
    for input_file in tqdm(glob.glob(args.input)):
        ...
        for s in samples:
            word_ids = get_best_sequence(s, eos_id, pad_id, alpha=args.alpha, length_penalty=args.length_penalty, expect=args.expect, min_len=args.min_len)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--expect", default=None, type=float, help="Expectation of target length.")
