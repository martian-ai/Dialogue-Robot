...
def createBosstingTree(trainDataList, trainLabelList, treeNum = 50):
    ...
    #获得训练集数量以及特征个数
    m, n = np.shape(trainDataArr) # m 训练集 n 特征数量
...
if __name__ == '__main__':
    ...
    trainDataList, trainLabelList = loadData('../corpus/mnist_train.csv')

    # 获取测试集
    print('start read testSet')
    testDataList, testLabelList = loadData('../corpus/mnist_test.csv')
