...
def main(train_file,
    ...
    Args:
        train_file (_type_): _description_
    ...
    bert_tokenizer = BertTokenizer.from_pretrained( \
        '../../resources/model/roberta_joint_sup_training', do_lower_case=True)
    #roberta_joint_sup_training
    ...
    model = BertModel('../../resources/model/roberta_joint_sup_training', 7).to(device)
...
if __name__ == "__main__":
    main("../../resources/dataset/clf_sentiemnt_car/train.tsv", \
         "../../resources/dataset/clf_sentiemnt_car/dev.tsv", "models-roberta-sentiment7")