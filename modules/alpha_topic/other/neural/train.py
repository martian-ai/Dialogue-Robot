...
if __name__ == '__main__':
    ...
    parser.add_argument("-test_mode",
                        ...
                        type=str,
                        choices=['ext', 'abs'])
    parser.add_argument("-src_data_mode",
                        default='utt',
                        type=str,
                        choices=['utt', 'word'])
    ...
    parser.add_argument("-coverage",
                        ...
                        const=True,
                        default=False)
    parser.add_argument("-copy_attn",
                        type=str2bool,
                        nargs='?',
                        const=True,
                        default=False)
    parser.add_argument("-copy_attn_force",
                        type=str2bool,
                        nargs='?',
                        const=True,
                        default=False)
    parser.add_argument("-copy_loss_by_seqlength",
                        type=str2bool,
                        nargs='?',
                        const=True,
                        default=False)
    ...
    parser.add_argument("-word_emb_mode",
                        default="word2vec",
                        type=str,
                        choices=["glove", "word2vec"])
    parser.add_argument("-word_emb_path",
                        default="pretrain_emb/word2vec",
                        type=str)
    parser.add_argument("-use_idf",
                        ...
                        const=True,
                        default=False)
    parser.add_argument("-split_noise",
                        type=str2bool,
                        nargs='?',
                        const=True,
                        default=False)
    ...
    parser.add_argument("-train_from_ignore_optim",
                        type=str2bool,
                        nargs='?',
                        const=True,
                        default=False)
