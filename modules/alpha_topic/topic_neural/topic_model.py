...
from topic import MultiTopicModel
from vocab_wrapper import VocabWrapper
# from id_wrapper import VocIDWrapper
...
class Model(nn.Module):
    def __init__(self, args, device, vocab, checkpoint=None):
        ...
        self.topic_model = MultiTopicModel(self.voc_emb.size(0), self.voc_emb.size(-1), args.topic_num, self.voc_emb, agent=True, cust=True)
