...
class TopicModel(nn.Module):
    ...
    def __init__(self, vocab_size, hidden_dim, topic_num, noise_rate=0.5):
        ...
        self.mlp = nn.Sequential( nn.Linear(vocab_size, 2*hidden_dim), nn.Tanh())
...
class MultiTopicModel(nn.Module):
    ...
    def forward(self, all_bow, customer_bow, agent_bow, summ_all_target=None, summ_customer_target=None, summ_agent_target=None):
