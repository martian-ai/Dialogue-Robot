...
class SquadReader(Dataset):
    def __init__(self,tokenizer, file_path):
        ...
        self.instances = [instance for instance in tqdm(instances)]
    ...
    def _read(self, file_path, context_limit=-1):
        ...
        for article in dataset:
            for paragraph in article['paragraphs']:
                ...
                context_tokens, context_token_spans = self.tokenizer.tokenize(context)
                for question_answer in paragraph['qas']:
                    question = question_answer["question"].strip()
                    question_tokens, _ = self.tokenizer.tokenize(question)
                    ...
                    if instance is None:
                        # print('squad.py _make_instance results is None, skip this qas')
                        continue
